...
<div>
    <table>
        <tbody>
            <tr>
                <td colspan="2" style="text-align:center;"><img src="../assets/upload/'.$row_shop['shop_img'].'" alt="7-Eleven" width="60"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2" style="text-align:right;">'.number_format($row_order_sale['product_total_price'],2)  .' บาท</td>
            </tr>
            <tr>
                <td colspan="1"></td>
