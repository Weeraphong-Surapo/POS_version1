...
$html .= '<table id="header">
      <tr>
        <td id="ht"><img src="../assets/upload/'.$row_shop['shop_img'].'" alt="7-Eleven" width="60"></td>
...
$html .= '<tr>
    <td colspan="4" style="text-align:right;" >มูลค่ารวมทั้งหมด</td>
    <td style="text-align:right;">'.number_format($row_order_sale['product_total_price'],2).'</td>
</tr>';
$html .= '<tr>
