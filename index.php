...
foreach ($query as $row) {
	$total_all_price += $row['product_total_price'];
		...
		<div class="card bg-warning invoice-card">
			<div class="card-body d-flex">
				...
				<div>
					...
					$count_product = $all_product->num_rows;
					?>
					<h2 class="text-white invoice-num"><?= $count_product;?> ชิ้น</h2>
					<span class="text-white fs-18">สินค้าทั้งหมด</span>
				</div>
			</div>
		</div>
	</div>
	<div class="col-xl-3 col-xxl-3 col-sm-6">
		<div class="card bg-success invoice-card">
			<div class="card-body d-flex">
				...
				?>
					<h2 class="text-white invoice-num"><?= $count_sale_day?> รายการ</h2>
					<span class="text-white fs-18">รายการขายวันนี้</span>
				</div>
			</div>
		</div>
	</div>
	<div class="col-xl-3 col-xxl-3 col-sm-6">
		<div class="card bg-info invoice-card">
			<div class="card-body d-flex">
				...
				<div>
				<?php 
					$all_sale = $conn->query("SELECT * FROM tb_sale");
					$count_all_sale = $all_sale->num_rows;
					?>
					<h2 class="text-white invoice-num"><?= $count_all_sale;?> รายการ</h2>
					<span class="text-white fs-18">รายการขายทั้งหมด</span>
				</div>
			</div>
		</div>
	</div>
	<div class="col-xl-3 col-xxl-3 col-sm-6">
		<div class="card bg-secondary invoice-card">
			<div class="card-body d-flex">
				...
				<div>
					<h2 class="text-white invoice-num"><?= number_format($total_price,2)?> บาท</h2>
					<span class="text-white fs-18">รายใด้วันนี้</span>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="col-xl-3">
						<div class="card-bx bg-blue">
							...
							<div class="card-info text-white">
								...
								<h2 class="text-white card-balance"><?=number_format($total_all_price,2)?> บาท</h2>
								<p class="fs-16">รายใด้ทั้งหมด</p>
							</div>
						</div>
					</div>
										...
										<tr>
											...
											<td>
												<div class="d-flex justify-content-center">
													...
													<button class="btn btn-danger btn-xs" onclick="DeleteStory(<?= $row['sale_id'] ?>)"><i class="mdi mdi-delete-forever"></i></button>
												</div>
											</td>
										</tr>
									<?php endforeach; ?>
